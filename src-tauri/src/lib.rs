...
use crate::commands::project_manager::{
    create_project, get_project_sessions, list_projects,
};
use crate::commands::claude::{
    ...
    get_home_directory, get_hooks_config, get_recently_modified_files, get_session_timeline,
    get_system_prompt, list_checkpoints, list_directory_contents, list_running_claude_sessions,
    ...
    save_temp_image, search_files, track_checkpoint_message, track_session_messages, update_checkpoint_settings,
    update_hooks_config, validate_hook_command, ClaudeProcessState,
};
use crate::commands::mcp::{
    mcp_add, mcp_add_from_claude_desktop, mcp_add_json, mcp_get, mcp_get_server_status, mcp_list,
    mcp_read_project_config, mcp_remove, mcp_reset_project_choices, mcp_save_project_config,
    mcp_serve, mcp_test_connection, plugin_install, plugin_uninstall,
};

use crate::commands::proxy::{apply_proxy_settings, get_proxy_settings, save_proxy_settings};
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // Load and apply proxy settings from the database
            {
                ...
                let proxy_settings = match db.0.lock() {
                    Ok(conn) => {
                        ...
                        let mut settings = crate::commands::proxy::ProxySettings::default();
                    ...
                    Err(e) => {
                        ...
                        crate::commands::proxy::ProxySettings::default()
                    }
                };
            ...
            if let Ok(claude_dir) = crate::utils::get_claude_dir() {
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Slash Commands
            crate::commands::slash_commands::slash_commands_list,
            crate::commands::slash_commands::slash_command_get,
            crate::commands::slash_commands::slash_command_save,
            crate::commands::slash_commands::slash_command_delete,
            // Proxy Settings
            get_proxy_settings,
            save_proxy_settings,
            // Models
            crate::commands::models::list_anthropic_models,
        ])
